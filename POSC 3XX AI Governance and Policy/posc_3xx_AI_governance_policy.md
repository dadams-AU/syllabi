...
header-includes:
  - |
    ```{=latex}
    % pandoc emits \ul for underlined spans; the template defines no
    % underline package, so map it onto plain \underline.
...
**Website:** [dadams.io](https://dadams.io)\
**Office Hours:** Mondays and Wednesdays, \[TBD\], and by [appointment](https://dadams.io/appointments).\
**Schedule meetings:** [dadams.io/appointments](https://dadams.io/appointments)
...
# Technical Problems
If you encounter any technical difficulties, contact the instructor immediately to document the problem. Then contact: [student IT help desk](http://www.fullerton.edu/it/students/helpdesk/index.php), [email](mailto:StudentITHelpDesk@fullerton.edu), phone (657) 278-8888, walk-in [student genius center](http://www.fullerton.edu/it/students/sgc/index.php), or online chat via the [portal](http://my.fullerton.edu) ("Online IT Help" then "Live Chat").

**[For issues with Canvas]{.underline}**: Canvas Support Hotline = (657) 278-8888, [search the CSUF Canvas Guides](https://canvashelp.fullerton.edu/), or [report a problem.](https://titans.service-now.com/sp?id=sc_cat_item&sys_id=f88efe80ebea6a10fb7cfcffcad0cdc6&subject=Canvas)
...
It is the student's responsibility to read and understand the required and important [student information for course syllabi](https://fdc.fullerton.edu/teaching/student-info-syllabi.html). Included is information about:
...
```{=latex}
\bigskip
\renewcommand{\refname}{Appendix: Reading List}
\renewcommand{\bibpreamble}{%
  Full citations for the assigned readings listed in the course schedule
  above. All items other than the required book are provided through
  \emph{Canvas} and the Pollak Library at no cost. Readings marked in the
  schedule as updated each offering (current investigative reporting, case
  dossiers, and regulatory trackers) are posted to \emph{Canvas} at the start
  of the semester and are not listed here.\par\vspace{0.75\baselineskip}}
