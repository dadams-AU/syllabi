...
% Encoding and PDF/A
\usepackage[utf8]{inputenc}  % harmless under LuaTeX, warning expected
\usepackage[T1]{fontenc}
\usepackage[a-1b]{pdfx}      % Handles PDF/A tagging and loads hyperref correctly
...
% Document metadata (safe with pdfx)
\hypersetup{
...
\author{Dr. David P. Adams \\
        Divison of Politics, Administration \& Justice \\
...
Assignments may be checked using plagiarism detection software.
...
Refer to Table \ref{tab:grade-weights} for detailed grade weights.
\phantomsection
\begin{table}[ht]
...
Refer to Table \ref{tab:grading-scale} for the letter grade scale.
\phantomsection
\begin{table}[ht]
