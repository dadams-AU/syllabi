...
\begin{enumerate}
    ...
    \item \textbf{In-Person Class Discussion and Peer Review Studio --- RED (Monday)}
        \begin{itemize}
            ...
            \item \textbf{Peer Review Studio (30 minutes)}: Students work in rotating pairs to give targeted feedback using the \emph{Peer Review Studio Checklist}, which is on the Track A Canvas page and applies to both tracks. Each student shares two actionable suggestions and one question with their partner, in writing, by the end of class. This is the artifact behind the fourth Seminar Performance criterion.
        \end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Contribution to another student's work.} The two actionable suggestions and one question you owe your partner in the peer review studio, in writing, every synthesis week. Actionable means they could act on it Tuesday.
