...
\begin{itemize}
    \item \textbf{Track A (Structured Self-Critique or Peer Feedback)}: Complete \emph{Track A: The Self-Critique Protocol}, posted on Canvas, either on your own work or in exchange with a classmate. No AI at any stage. Read its opening section before you choose a track; it makes an argument you are entitled to hear.
...
\begin{enumerate}
    ...
    \item \textbf{In-Person Class Discussion and Peer Review Studio (Monday)}
        \begin{itemize}
            ...
            \item \textbf{Peer Review Studio (30 minutes)}: Students work in rotating pairs to give targeted feedback using the \emph{Peer Review Studio Checklist} (posted on Canvas, and included with the Track A protocol). Each student shares two actionable suggestions and one question with their partner, in writing, by the end of class.
        \end{itemize}
...
\begin{table}[h]
    ...
    \begin{tabularx}{\linewidth}{L L}
    \rowcolor{gray!20}
    \textbf{Assignment} & \textbf{Where AI may be used} \\
Annotated bibliography (weekly) & Feedback Appendix only, Track B approved prompt \\
Final synthesis paper (weekly) & Feedback Appendix only, Track B approved prompt \\
Rough draft synthesis paper (weekly) & Nowhere \\
Personal reflection (weekly) & Nowhere \\
Comparative Matrix, Version 1 (Week 2) & Nowhere, on either track \\
Book Deep-Dive, Parts A and B (Weeks 8, 11) & Nowhere, on either track \\
Reading discussion facilitation & Nowhere: questions, activities, and the post-class reflection are yours \\
Field Map (Week 12) & Nowhere, on either track \\
MPA comprehensive general area essay exam & Nowhere \\
Concentration Area Paper (all four stages) & Nowhere \\
    \end{tabularx}
\end{table}
\end{center}
...
\vspace{0.5em}
\noindent \textbf{If an assignment does not say, it is a no-AI assignment.} Ask me and I will tell you, and asking costs you nothing. This policy opens one narrow door, so silence is not a second one. An assignment I forgot to mark is my oversight to fix rather than a gap for you to work in.
...
\begin{itemize}
    ...
    \item Quality of the \textbf{Feedback Appendix}, which is required every week: useful critique plus evidence you understood it.
    \item The \textbf{Next-Week Plan} (5--7 bullets) showing how you will apply the critique to \textbf{next week's} work.
...
\vspace{0.5em}
\noindent \textbf{We will take a few minutes at several points in the term to revisit this policy and work through edge cases that have actually come up.} Bring them. A case you are unsure about is more useful to the whole class than a rule I wrote in August.
