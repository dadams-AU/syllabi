...
\begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \end{itemize}
                \end{itemize}
                \item \textbf{Feedback Appendix (Weeks 2--4 Required; Week 5+ Optional)}: Students may use tools such as OpenAI's \href{https://chat.openai.com/}{ChatGPT}, Anthropic's \href{https://www.anthropic.com/}{Claude}, Google's \href{https://www.google.com/search/about/}{Gemini}, or the university's \href{https://titangpt.fullerton.edu/auth/jwt/login}{TitanGPT} to request feedback. If you prefer not to use AI, request an alternative (e.g., peer feedback or a structured self-critique) and include that in the appendix.
                \item \textbf{Sample Prompt}:
                \begin{quote}
                    \texttt{``You are my writing coach for a graduate PA seminar. Please review one annotated bibliography entry. Check for accuracy of the summary, clarity of the relevance statement, and any missing concepts from the reading. Return: (1) 3 bullet critiques, (2) 1 suggestion for improvement, and (3) 1 discussion question. Do not rewrite my text.''}
                \end{quote}
            \end{itemize}
        \end{itemize}
    ...
    \item \textbf{In-Person Class Discussion and Peer Review Studio (Monday)}
        \begin{itemize}
            ...
            \item \textbf{Peer Review Studio (30 minutes)}: Students work in rotating pairs to give targeted feedback using a short checklist. Each student submits two actionable suggestions and one question to Canvas by the end of class.
        \end{itemize}
    ...
    \item \textbf{Final Synthesis Paper (20 points; Due Wednesday Night)}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item \textbf{Feedback Appendix (Required)}: Students must include feedback in an appendix attached to the final synthesis paper submission. AI feedback is recommended; approved alternatives (peer feedback or structured self-critique) are acceptable with prior notice.
                \begin{quote}
                    \texttt{``Act as a critical reviewer for my synthesis paper. Identify 3 strengths, 3 gaps in reasoning or evidence, 2 counterarguments I should address, and 2 additional connections across readings. Do not rewrite my paper or add new content.''}
                \end{quote}
                \item Include all feedback used during the week (AI or other) in the appendix to the final synthesis paper.
            \end{itemize}
        \end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Feedback Appendix (Required)}: Use an AI tool for critique on Part B and include the response in your appendix. If you prefer not to use AI, request an alternative (peer feedback or structured self-critique) and include that in the appendix.
    \begin{quote}
        \texttt{``Review my decision and practice memo for clarity, feasibility, and use of evidence. Identify 2 strengths, 2 weak spots, and 1 alternative approach I should consider. Do not rewrite the memo.''}
    \end{quote}
\end{itemize}
...
\begin{table}[h]
    ...
    Cite AI when it meaningfully shaped your thinking (e.g., ``ChatGPT feedback, 2/9/26''). & Omit citation when AI influenced your work. \\
...
\begin{itemize}
    ...
    \item Final projects that demonstrate original critical thinking, even if AI-supported feedback informed revisions.
\end{itemize}
