...
\begin{enumerate}
    ...
    \item \textbf{Rough Draft Synthesis Paper (Due Monday Before Class)}
    \begin{itemize}
    ...
    \item \textbf{Final Synthesis Paper (Due Wednesday Night) and Reflection (Due Friday Night)}
    \begin{itemize}
...
\begin{itemize}
    \item \textbf{Part A: Concept Application Memo (Due Monday Before Class)}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Part B: Decision and Practice Memo (Due Wednesday Night)}
    \begin{itemize}
