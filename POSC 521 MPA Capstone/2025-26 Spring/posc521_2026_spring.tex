...
\begin{enumerate}
    ...
    \item \textbf{Final Synthesis Paper (20 points; Due Wednesday Night) and Reflection (10 points; Due Friday Night)}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Monday (3/23)}: Class Discussion on practice exam prompt
    \item \textbf{Due Saturday (3/28)}: Practice Comprehensive Exam Essay
\end{itemize}

\subsection*{Week 11, Starting 3/30: Spring Break}
\begin{itemize}
    \item \textbf{No Class}: Spring Break
\end{itemize}

\subsection*{Week 12, Starting 4/6: Comprehensive General Area Essay Exam}
\begin{itemize}
    \item \textbf{In-person Session}: Comprehensive exam launch and Q\&A
    \item \textbf{Comprehensive General Area Exam distributed Friday (4/10) at 8:00 a.m.}
\end{itemize}

\subsection*{Week 13, Starting 4/13: Comprehensive General Area Essay Exam}
\begin{itemize}
    \item \textbf{Asynchronous Session}: No class meeting
    \item \textbf{Comprehensive General Area Exam due Thursday (4/16) by 4:59 p.m.}
\end{itemize}

\subsection*{Week 14, Starting 4/20: Concentration Area Paper}
\begin{itemize}
...
\subsection*{Week 15, Starting 4/27: Concentration Area Paper}
\begin{itemize}
    \item \textbf{In-Person Session}: Concentration Area Paper Workshop
    \item \textbf{Due Sunday (5/3)}: Literature Review Draft
\end{itemize}

\subsection*{Week 16, Starting 5/4: Concentration Area Paper}
\begin{itemize}
    \item \textbf{Asynchronous Session}: Concentration Area Paper
    \item \textbf{Due: Final Draft on Tuesday (5/5) by 9:00 p.m.}
\end{itemize}
