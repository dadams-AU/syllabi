...
\begin{itemize}
    ...
    \begin{itemize}
        \item Annotated Bibliography: Due Mondays by class time (Weeks 2--9)
        \item Rough Draft Synthesis Paper: Due Mondays by class time (Weeks 2--9)
        \item Final Synthesis Paper or Book Alternative: Due Wednesdays by 11:59 p.m. (Weeks 2--9)
        \item Personal Reflection: Due Fridays by 11:59 p.m. (Weeks 2--9)
        \item Week 1 Alternative Assignment: Due Friday, 1/23
    \end{itemize}
    \item \textbf{Point values (Canvas):} Annotated bibliographies = 5 points each; rough draft synthesis papers = 10 points each; final synthesis papers = 20 points each; reflections = 10 points each; concept application memo (Part A, Weeks 6 and 9) = 10 points each; decision and practice memo (Part B, Weeks 6 and 9) = 20 points each.
    \item Practice Comprehensive Exam Response:
    \begin{itemize}
        \item Distributed in Week 10 (Sunday, 3/22)
        \item Due on Saturday, 3/28 by 11:59 p.m.
    \end{itemize}
    \item MPA Comprehensive General Area Essay Exam:
    \begin{itemize}
        \item Distributed on Friday, 4/10 at 8:00 a.m.
        \item Due on Thursday, 4/16 by 4:59 p.m.
    \end{itemize}
    \item Concentration Area Paper:
    \begin{itemize}
        \item Topic Selection: Due Week 14 (Sunday, 4/19)
        \item Literature Review Draft: Due Week 15 (Sunday, 5/3)
        \item Workshop Participation: Week 15 (Monday, 4/27)
        \item Final Draft: Due Tuesday, 5/5 by 9:00 p.m.
    \end{itemize}
\end{itemize}
...
Practice comprehensive exam due Saturday, 3/28. Comprehensive general area essay exam due Thursday, 4/16.
...
\textbf{Important Note:} Beginning in Week 2, all students are required to include copies of their AI feedback as an \emph{appendix} to their final weekly submission. AI feedback is:
\begin{itemize}
    ...
    \item \textbf{Final Synthesis Paper (20 points; Due Wednesday Night)}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item \textbf{AI Feedback (Required)}: Students must use an AI tool for feedback and copy/paste the AI response into an appendix attached to the final synthesis paper submission.
                \begin{quote}
                ...
                \end{quote}
                \item Include all AI feedback used during the week (if any) in the appendix to the final synthesis paper.
            \end{itemize}
        \end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{AI Feedback (Required)}: Use an AI tool for critique on Part B and include the response in your appendix.
    \begin{quote}
...
\begin{itemize}
    \item \textbf{Asynchronous Class}: Question opens on Monday. In class we'll have a final preparation.
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Length: 1,620 words maximum (approximately 5--6 pages, double-spaced).
