...
\begin{itemize}
    ...
    \begin{itemize}
            ...
            \item No AI assistance allowed for this memo. It must be written entirely by you to capture your independent analysis of the book's concepts and their application. Feedback not required but you may share your memo with peers for feedback if desired (not AI). The goal is to produce a memo that reflects your own thinking and understanding of the book's insights as they apply to public service practice.
        \end{itemize}
...
\paragraph*{AI Use and Academic Integrity:} AI may be used to provide feedback, raise questions, or suggest additional angles for analysis. It may \textbf{not} be used to draft or rewrite your work. All writing must remain your own. Tools like Grammarly are permitted for spelling, grammar, and mechanics checks only; do not use them for rewriting, paraphrasing, or style transformations. Do not input confidential or sensitive data into AI tools. Please read the \textbf{Policy on the Use of Generative AI and Other Technology} section of this syllabus for more details on how to use AI responsibly in this course and refer to Table \ref{tab:ai-guidelines} and the more detailed guidelines provided below.
...
Use tools like Grammarly for \textbf{spelling, grammar, and mechanics} checks. & Use Grammarly or similar tools to \textbf{rewrite, paraphrase, or transform style/structure}. \\
...
\begin{itemize}
    ...
    \item \textbf{Allowed (Basic Mechanics)}: Tools like Grammarly are permitted for \textbf{spelling, grammar, punctuation, and formatting checks}. Do \textbf{not} use these tools for rewriting, paraphrasing, or style transformations.
