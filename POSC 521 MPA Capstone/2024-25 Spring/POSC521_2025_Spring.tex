...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{Optional Reflection}:
            \begin{itemize}
                \item Reflect on your learning process and the feedback received.
                \item Use ChatGPT to refine reflections:
                \begin{quote}
...
\paragraph{Weeks 2–8: Standard Weekly Workflow}
...
\paragraph{Week 9: 21st Century Challenges}
\begin{itemize}
    \item \textbf{Content}:
    \begin{itemize}
        ...
        \item \citet{Denhardt2015}, *The New Public Service*, Chapters 10–12.
    \end{itemize}
    \item \textbf{Assignments}:
    \begin{itemize}
        \item Annotated Bibliography (due Tuesday before class).
...
\paragraph{Annotated Bibliography Rubric}
\begin{table}[h!]
\centering
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Criteria} & \textbf{Excellent (3)} & \textbf{Satisfactory (2)} & \textbf{Needs Improvement (1)} \\
\hline
Citation Format & Accurate APA/Chicago citation. & Minor formatting errors. & Significant errors. \\
Summary & Clear and concise. Covers key points. & Partial summary or unclear. & Missing key details. \\
Relevance & Strong, clear connection to topic. & Some connection to topic. & Unclear or weak connection. \\
\hline
\end{tabular}
\end{table}

\paragraph{Synthesis Paper Rubric}
\begin{table}[h!]
\centering
\begin{tabular}{|l|c|c|c|}
\hline
\textbf{Criteria} & \textbf{Excellent (5)} & \textbf{Satisfactory (3)} & \textbf{Needs Improvement (1)} \\
\hline
Analysis & Thorough analysis with connections and contradictions. & Some connections but lacks depth. & Little analysis or connections. \\
Organization & Clear structure and flow. & Somewhat organized. & Disorganized or unclear. \\
Writing & Well-written, few errors. & Minor errors but readable. & Frequent errors, unclear. \\
\hline
\end{tabular}
\end{table}
