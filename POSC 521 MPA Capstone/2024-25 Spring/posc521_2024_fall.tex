...
\item \textbf{Synthesis - Kritik Component}

\begin{itemize}
    \item \textbf{Purpose}: Integrate main themes and insights from weekly readings, discussing their implications for public administration. This component will be conducted on the Kritik platform, and all papers should be submitted anonymously to ensure unbiased feedback.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Identifying patterns, connections, and contradictions across the readings.
        \end{itemize}
        \item Submit your synthesis to Kritik for peer feedback.
        \item Provide constructive feedback to at least three classmates through Kritik.
        \item Revise your synthesis based on peer feedback received through Kritik.
    \end{itemize}
    
    \item \textbf{Submission}:
    \begin{itemize}
        \item Submit your initial synthesis to Kritik for peer review and feedback.
        \item Complete peer reviews on at least three classmates' submissions.
        \item Revise your synthesis based on the feedback received from Kritik peer reviews.
    \end{itemize}
    
    \item \textbf{Grading}:
    \begin{itemize}
        \item Your grade will be based on the quality of your synthesis, participation in peer reviews, and the revisions made based on feedback.
    \end{itemize}
\end{itemize}

\item \textbf{Synthesis - Canvas Component}

\begin{itemize}
    \item \textbf{Purpose}: Submit the revised synthesis after peer review, ensuring that the final version reflects thoughtful analysis and consideration of previous feedback.
    
    \item \textbf{Process}:
    \begin{itemize}
        \item After revising your synthesis from the Kritik peer reviews, submit it to an AI tool for feedback using the following prompt:
        
        \textit{"I've synthesized information from [number] articles on [topic]. Here's my draft of the synthesis [insert draft]. Could you provide feedback and suggest any connections or contrasts I might have missed?"}
        
        \item You must include the AI feedback output with your final submission to Canvas.
        \item Revising your synthesis based on AI feedback is optional but encouraged for improvement.
    \end{itemize}
    
    \item \textbf{Submission}:
    \begin{itemize}
        \item Submit your revised synthesis \emph{along with the AI feedback output} to Canvas for grading.
        \item Ensure that both the final paper and the AI feedback are submitted in a single file to Canvas.
    \end{itemize}
    
    \item \textbf{Grading}:
    \begin{itemize}
        \item Your Canvas grade will be based on the quality of your synthesis and submission of the AI feedback.
        \item Updating your synthesis based on AI feedback is optional and will not impact the grade.
    \end{itemize}
\end{itemize}
...
Students will complete a literature review in their concentration area as part of the MPA program's comprehensive exam requirement. The literature review will examine practical and theoretical issues related to a specific public administration topic and synthesize essential findings and debates in the literature. This assignment allows students to deepen their knowledge of their concentration area and develop their research and writing skills. The literature review should be approximately 15 pages, double-spaced, in APA or Chicago author-date style.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Ensure the topic addresses both practical and theoretical dimensions of public administration.
        \item Formulate a clear research question that guides your literature review.
    \end{itemize}
    \item \textbf{Annotated Bibliography:}
    \begin{itemize}
        \item Compile an annotated bibliography of at least 10-12 peer-reviewed sources.
        \item Provide a summary and critical evaluation of each source's relevance to your research question.
    \end{itemize}
    \item \textbf{Theoretical Book Requirement:}
    \begin{itemize}
        \item Select a theoretical book related to your concentration area to incorporate into your literature review.
        \item Analyze the book’s contribution to the field and its relevance to your topic.
    \end{itemize}
    \item \textbf{Literature Sources:}
    \begin{itemize}
        \item Utilize a minimum of 15 peer-reviewed articles or books.
        \item Incorporate recent studies to ensure an up-to-date analysis of the topic.
    \end{itemize}
    \item \textbf{Structure:}
    \begin{itemize}
        \item \textbf{Introduction:} State the research question and discuss its significance in the field of public administration.
        \item \textbf{Literature Review:} Summarize and synthesize key findings and debates from the literature, demonstrating an understanding of both practical and theoretical perspectives.
        \item \textbf{Analysis:} Critically evaluate the literature, identify gaps, and discuss possible directions for future research.
        \item \textbf{Conclusion:} Summarize the main findings and their implications for public administration theory and practice.
    \end{itemize}
    \item \textbf{Final Draft Deliverable:}
    \begin{itemize}
        \item Submit the final draft of your literature review on Canvas by the deadline specified in the course syllabus.
        \item Ensure that the final draft adheres to all assignment requirements and is professionally formatted.
    \end{itemize}
\end{enumerate}

\paragraph*{Submission Timeline:}
\begin{itemize}
    \item \textbf{Topic Outline:} Due Week 12
    \item \textbf{Annotated Bibliography:} Due Week 13
    \item \textbf{First Draft:} Due Week 14
    \item \textbf{Final Draft:} Due Week 16
\end{itemize}

\subsubsection*{Example Term Paper Research Questions by Concentration}

\paragraph*{1. Public Policy}
\begin{itemize}
    \item \textbf{Research Question:} How do stakeholder engagement processes influence the implementation of environmental policies at the local level?
    \item \textbf{Explanation:} This question allows the student to explore both the practical aspects (stakeholder engagement) and theoretical dimensions (policy implementation models) of public policy.
\end{itemize}

\paragraph*{2. Local Government Management}
\begin{itemize}
    \item \textbf{Research Question:} What are the most effective strategies for improving intergovernmental collaboration in metropolitan regions?
    \item \textbf{Explanation:} This question addresses the practical challenges of collaboration between local governments and evaluates the theoretical frameworks for intergovernmental relations.
\end{itemize}

\paragraph*{3. Public Finance}
\begin{itemize}
    \item \textbf{Research Question:} How does participatory budgeting affect fiscal transparency and public trust in local governments?
    \item \textbf{Explanation:} The question allows exploration of the impact of participatory processes on financial governance, connecting theoretical insights with real-world financial practices.
\end{itemize}

\paragraph*{4. Human Resources (HR)}
\begin{itemize}
    \item \textbf{Research Question:} What role do diversity and inclusion policies play in reducing turnover in public sector organizations?
    \item \textbf{Explanation:} This question allows the student to analyze how diversity policies are implemented in public HR and to evaluate their theoretical effectiveness on employee retention.
\end{itemize}
...
\begin{table}[h!]
    ...
    \midrule
    Weekly Annotated Bibliographies & 5\% \\
    Weekly Kritik Assignment & 5\% \\
    Weekly Syntheses & 15\% \\
