...
\title{POSC 588, Collaborative Governance}
\author{}
\date{Spring 2026}
...
\noindent \textbf{Office hours:} Mondays and Tuesdays from 11:00--1:00, Tuesdays from 5:30 to 6:30, and by \href{https://dadams.io/appointments}{appointment}. \\
\noindent \textbf{Schedule meetings throughout the week:} \href{https://dadams.io/appointments}{dadams.io/appointments}
...
\noindent \textbf{Meeting times with modality, day(s), time(s), and location:} In-Person, Tuesdays at 7:00 p.m., Gordon Hall 208
...
\item \textbf{Required text(s):} \citet{Agranoff2012}; \citet{EmersonNabatchi2015}; \citet{Henderson2015}; \citet{OLeary2009}
\end{flatlist}
...
\subsection*{Weekly Flow}
Each week follows a consistent flow to help you manage your time and expectations.
...
Three weeks are structured asynchronous \emph{work weeks}. These replace in-person meetings and are designed to move your team project forward.
\begin{itemize}
...
\subsection*{2/10 -- Week 4: ASYNC WORK WEEK (Required)}
    ...
    \subsubsection*{Readings (lighter but foundational)}
        \begin{itemize}
            \item \citet{EmersonNabatchi2015}: Chapter 2 and Chapter 3 
...
\subsection*{3/10 -- Week 8: ASYNC WORK WEEK}
    \subsubsection*{Theme}
...
\subsection*{4/7 -- Week 11: Signature OC/LA Basin Simulation}
    \subsubsection*{In Class}
        \begin{itemize}
...
\subsection*{4/14 -- Week 12: ASYNC WORK WEEK}
    \subsubsection*{Theme}
...
\subsection*{4/28 -- Week 14: Integration: Redesign Under Political Heat}
    \subsubsection*{In Class}
        \begin{itemize}
            \item Rapid redesign clinic under new constraints and political pressures
        \end{itemize}
    \subsubsection*{Readings}
        \begin{itemize}
